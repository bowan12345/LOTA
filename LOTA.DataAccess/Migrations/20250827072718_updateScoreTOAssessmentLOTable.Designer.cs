...
namespace LOTA.DataAccess.Migrations
{
    ...
    [Migration("20250827072718_updateScoreTOAssessmentLOTable")]
    partial class updateScoreTOAssessmentLOTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LOTA.Model.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "TUTOR-001",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e3062c68-c2b2-44bb-8448-3fff6dfa98ec",
                            ...
                            SecurityStamp = "88c06e2a-16da-43da-975b-3b56cdc5ef0d",
                        ...
                        new
                        {
                            Id = "STUDENT-001",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e626f9bf-2899-452d-b01f-c2a8f1d63b49",
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "3847a896-3cf8-49d8-80b8-0caac10116d0",
            ...
            modelBuilder.Entity("LOTA.Model.Assessment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "TUTOR-001",
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6420),
                            IsActive = true,
                            Score = 100m,
            ...
            modelBuilder.Entity("LOTA.Model.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6293),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6296),
            ...
            modelBuilder.Entity("LOTA.Model.LearningOutcome", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "LO-001",
                            CourseId = "COURSE-001",
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6377),
                        ...
                        new
                        {
                            Id = "LO-002",
                            CourseId = "COURSE-001",
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6380),
            ...
            modelBuilder.Entity("LOTA.Model.Qualification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6221),
                            IsActive = true,
                            Level = 7,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6273),
                            IsActive = true,
                            Level = 5,
            ...
            modelBuilder.Entity("LOTA.Model.StudentCourse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "STCOURSE-001",
                            CourseOfferingId = "TC001",
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6457),
                            IsActive = true,
                            RegistrationDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6455),
            ...
            modelBuilder.Entity("LOTA.Model.StudentScore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "SCORE-001",
                            AssessmentId = "ASSIGN-001",
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6474),
                            IsRetake = false,
                            LOId = "LO-001",
                            Score = 80m,
                            Status = "Pass",
            ...
            modelBuilder.Entity("LOTA.Model.Trimester", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "Trimester-001",
                            AcademicYear = 2024,
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6333),
                            IsActive = true,
                            TrimesterNumber = 1
                        },
                        new
                        {
                            Id = "Trimester-002",
                            AcademicYear = 2024,
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6335),
                            IsActive = true,
                            TrimesterNumber = 2
                        },
                        new
                        {
                            Id = "Trimester-003",
                            AcademicYear = 2025,
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6336),
                            IsActive = true,
                            TrimesterNumber = 1
                        },
                        new
                        {
                            Id = "Trimester-004",
                            AcademicYear = 2025,
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6338),
                            IsActive = true,
                            TrimesterNumber = 2
                        });
                });
            ...
            modelBuilder.Entity("LOTA.Model.TrimesterCourse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "TC001",
                            CourseId = "COURSE-001",
                            CreatedDate = new DateTime(2025, 8, 27, 19, 27, 14, 944, DateTimeKind.Local).AddTicks(6358),
                            IsActive = true,
                            TrimesterId = "Trimester-001",
                            TutorId = "TUTOR-001"
                        });
